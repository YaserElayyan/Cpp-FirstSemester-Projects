...
int SumOfOddNumbersInArray(int Arr[100], int ArrLength)
{
	int Sum = 0;
	for (int i = 0; i < ArrLength; i++)
	{
...
int CountOfOddNumbersInArray(int Arr[100], int ArrLength)
{
	int Count = 0;
	for (int i = 0; i < ArrLength; i++)
	{
...
int main()
{
	...
	cout << "Odd Numbers Sum is: " << SumOfOddNumbersInArray(Arr, ArrLength) << endl;
	cout << "Count Of Odd Number is: " << CountOfOddNumbersInArray(Arr, ArrLength);
	return 0;
}